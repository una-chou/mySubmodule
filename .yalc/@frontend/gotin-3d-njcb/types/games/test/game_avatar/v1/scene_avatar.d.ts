...
import { BasicsNodeList, ConflictNodeMap, ChoiceGroupObj } from '../v3/modules/data_interface';
export declare class SceneAvatar {
    ...
    private _avatarKuziIndex;
    private _avatarShangyiIndex;
     ...
     * @param obj
     */
    replaceAvatar(showId: string, hideId: string, list: BasicsNodeList, map: ConflictNodeMap, obj: ChoiceGroupObj): void;
    last(): void;
    next(): void;
