...
type ModuleNameType = 'user' | 'home' | 'auth' | 'nim' | 'goods' | 'task' | 'config' | 'share' | 'sign' | 'lottery' | 'duck'
/**
...
export function setStoreState<T>(module: ModuleNameType, key: keyof T, value: any): void {
  store.commit({
    type: module + '/__set',
    key: key,
    val: value,
 ...
 */
export function dispatchAction<T>(module: ModuleNameType, key: keyof T, value?: any): void {
 ...
 */
export function getStoreGetter<T>(module: ModuleNameType, key: keyof T): void {
